                    ...
                    <Draggable key={item.id} draggableId={item.id} index={index}>
                      {(provided, snapshot) => (
                        ...
                        >
                          ...
                          <td>
                            <div style={{ fontWeight: '600' }}>{item.title || item.category || item.heading}</div>
                            <div style={{ fontSize: '0.8rem', color: 'var(--text-secondary)' }}>{item.date_badge || item.category_slug || item.kind || item.scene_id}</div>
                          </td>
